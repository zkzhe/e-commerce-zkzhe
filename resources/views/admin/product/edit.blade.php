...
<div class="sl-pagebody">
    ...
    <div class="card pd-20 pd-sm-40">
        ...
        <form method="post" action="{{ URL::to('admin/update/product/photo/'.$product->id) }}" enctype="multipart/form-data">
            @csrf
            <div class="row">
                ...
                <div class="col-lg-6 col-sm-6">
                    <img src="{{ URL::to($product->image_one) }}" id="one" style="width:80px; height:80px;">
                </div>
                ...
                <div class="col-lg-6 col-sm-6">
                    <img src="{{ URL::to($product->image_two) }}" id="one" style="width:80px; height:80px;">
                </div>
                ...
                <div class="col-lg-6 col-sm-6">
                    <img src="{{ URL::to($product->image_three) }}" id="three" style="width:80px; height:80px;">
                </div>
            </div><!-- col-4 -->
            <br>
