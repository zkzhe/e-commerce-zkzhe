                ...
                <table id="datatable1" class="table display responsive nowrap">
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td>
                                <a href="{{ URL::to('admin/edit/coupon/'.$value->id) }}" class="btn btn-sm btn-info">Edit</a>
                                <a href="{{ URL::to('admin/delete/coupon/'.$value->id) }}" class="btn btn-sm btn-danger" id="delete">Delete</a>
                            </td>
                        </tr>
                        @endforeach
                    </tbody>
